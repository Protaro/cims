<script lang="ts">
    import Prework from "$lib/phases_contractediting/Prework.svelte";
    import ReviewApproval from "$lib/phases_contractediting/ReviewApproval.svelte";
    import SigningActivation from "$lib/phases_contractediting/SigningActivation.svelte";
    import Postwork from "$lib/phases_contractediting/Postwork.svelte";
